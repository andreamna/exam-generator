...
## 📌 개요
Document Parse과 AI같은 기술을 이용하여 강의 자료 기반으로 학교 시험지를 자동 평가와 만든 시스템입니다

## 🎯 문제 정의 및 기대 효과
> '어떤 문제를 해결하고자 했는가?', '해당 문제의 중요성과 필요성은 무엇인가?', '이 솔루션이 사용자 혹은 조직에 어떤 가치를 줄 수 있는가?' 등
> 해당하는 내용을 작성해주세요.
어떤 과목 분반에 학생들이 많으며 교수님은 따로 일이도 있는 이유로 시험 결과를 나오는 것은 오래 걸리는 경우가 많음.
이럴때 다음 시험을 다가오면서 지난 시험 결과를 모르는 학생은 준비가 어려워진다.
